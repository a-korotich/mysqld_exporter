...
collect.using_partitions                                     | 5.7           | Collect tables where partitions are used
collect.partitions_to_remove                                 | 5.7           | Collect tables where partitions older than 3 month
